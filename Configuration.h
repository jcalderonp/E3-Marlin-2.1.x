...
#define STRING_CONFIG_H_AUTHOR "(3dc.rd)" // Who made the changes.
//#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quotes)

#define SHOW_CUSTOM_BOOTSCREEN
//#define CUSTOM_STATUS_SCREEN_IMAG
...
#define CUSTOM_MACHINE_NAME "@3dc.rd, Ender-3"
...
//#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_EDIT_MENU         // Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash) // @3dc.rd
  #define PID_AUTOTUNE_MENU     // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash) //@3dc.rd
#endif
...
//#define MAG_MOUNTED_PROBE
  ...
  #define MAG_MOUNTED_STOW_4   { PROBE_STOW_FEEDRATE,   { 220, 114, 20 } }  // Side move to remove probe
...
//#define Z_CLEARANCE_FOR_HOMING  4 // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
                                    // (@3dc.rd) Be sure to have this much clearance over your Z_MAX_POS to prevent grinding.
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (50*60) } // @3dc.rd (Revisar)
